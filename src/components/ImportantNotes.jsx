    ...
    <div className="container">
      <Animated>
        <section className="mt-24">
          ...
          <div name="Attractions">
            <h3>What is in the common area:</h3>
            <div className="adaptiveGrid gap-3 pt-6">
      ...
      <Animated>
        ...
        <section className="my-[60px]">
          ...
          <div className="flex gap-8 md:gap-16 font-light text-24 marker:text-xs sm:marker:text-base border-darkGreen border-b pb-[60px]">
